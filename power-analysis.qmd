...
*N is the number of infants **per group**: for a within-participant design
(most MetaLab datasets) that is the total number of infants; for a
between-participant design, each condition needs N infants.*
