...
Black points are the observed effect sizes (with 95% CIs); **colored
triangles are the model's estimated effect sizes** given the selected
moderators (one color per moderator group — with no moderators selected,
every study shares the overall meta-analytic estimate).
