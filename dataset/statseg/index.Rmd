...
tags: 
- early_language
summary: Can infants segment words from artificial mini-languages based on syllable-level statistics?<br>31 papers | 103 experiments | 1546 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "statSeg")
dataset_raw <- metalab_data %>% filter(short_name == "statSeg")
```
# `r dataset_info$name` 
