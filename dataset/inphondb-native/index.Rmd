---
title: Vowel discrimination (native)
layout: data
type: dataset
tags: 
- early_language
summary: Discrimination of native-language vowels, including results from a variety of methods.<br>33 papers | 145 experiments | 2491 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "inphondb-native")
dataset_raw <- metalab_data %>% filter(short_name == "inphondb-native")
```
# `r dataset_info$name` 
