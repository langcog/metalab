---
title: Mispronunciation sensitivity
layout: data
type: dataset
tags: 
- early_language
summary: Can infants distinguish correctly and mispronounced words, like dog and tog?<br>32 papers | 251 experiments | 2047 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "MPs")
dataset_raw <- metalab_data %>% filter(short_name == "MPs")
```
# `r dataset_info$name` 
