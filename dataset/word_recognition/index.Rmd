---
title: Online word recognition
layout: data
type: dataset
tags: 
- early_language
summary: Online word recognition of familiar words using two-alternative forced choice preferential looking.<br>6 papers | 15 experiments | 366 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "word_recognition")
dataset_raw <- metalab_data %>% filter(short_name == "word_recognition")
```
# `r dataset_info$name` 
