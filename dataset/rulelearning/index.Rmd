---
title: Abstract rule learning
layout: data
type: dataset
tags: 
- early_language
summary: Can infants learn abstract repition rules from different types of stimuli?<br>20 papers | 95 experiments | 1111 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "ruleLearning")
dataset_raw <- metalab_data %>% filter(short_name == "ruleLearning")
```
# `r dataset_info$name` 
