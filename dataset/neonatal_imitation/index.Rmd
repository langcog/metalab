...
summary: Does neonatal imitation exist? Insights from a meta-analysis of 336 effect sizes<br>26 papers | 336 experiments | 949 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "neonatal_imitation")
dataset_raw <- metalab_data %>% filter(short_name == "neonatal_imitation")
```
# `r dataset_info$name` 
