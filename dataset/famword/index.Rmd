...
tags: 
- early_language
summary: Do infants distingusih familiar words from novel/rare words in listening tasks?<br>16 papers | 34 experiments | 658 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "famWord")
dataset_raw <- metalab_data %>% filter(short_name == "famWord")
```
# `r dataset_info$name` 
