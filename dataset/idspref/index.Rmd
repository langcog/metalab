---
title: Infant directed speech preference
layout: data
type: dataset
tags: 
- early_language
summary: Looking times as a function of whether infant-directed vs. adult-directed speech is presented as stimulation.<br>32 papers | 117 experiments | 1694 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "idspref")
dataset_raw <- metalab_data %>% filter(short_name == "idspref")
```
# `r dataset_info$name` 
