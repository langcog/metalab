---
title: Function word segmentation
layout: data
type: dataset
tags: 
- early_language
summary: Recognition of familiarized function words from natural speech using behavioral methods.<br>5 papers | 17 experiments | 290 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "inworddb_function")
dataset_raw <- metalab_data %>% filter(short_name == "inworddb_function")
```
# `r dataset_info$name` 
