---
title: Natural speech preference
layout: data
type: dataset
tags: 
- early_language
summary: Do infants prefer natural speech over other types of sound?<br>19 papers | 55 experiments | 770 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "SpeechPref")
dataset_raw <- metalab_data %>% filter(short_name == "SpeechPref")
