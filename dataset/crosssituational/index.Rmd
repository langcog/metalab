---
title: Cross-situational word learning
layout: data
type: dataset
tags: 
- early_language
summary: Infants and children s abilities to learn words across multiple ambiguous situations.<br>16 papers | 50 experiments | 2271 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "CrossSituational")
dataset_raw <- metalab_data %>% filter(short_name == "CrossSituational")
```
# `r dataset_info$name` 
