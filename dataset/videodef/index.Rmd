...
summary: Learning from video versus face to face presentation of similar content.<br>69 papers | 122 experiments | 3004 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "videodef")
dataset_raw <- metalab_data %>% filter(short_name == "videodef")
```
# `r dataset_info$name` 
