---
title: Gaze following (video)
layout: data
type: dataset
tags: 
- cognitive_development
summary: Gaze following using video-based first look paradigms<br>15 papers | 52 experiments | 847 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "vidgazefollow")
dataset_raw <- metalab_data %>% filter(short_name == "vidgazefollow")
```
# `r dataset_info$name` 
