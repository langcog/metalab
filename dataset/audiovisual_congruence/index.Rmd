---
title: Audio-Visual Congruence
layout: data
type: dataset
tags: 
- early_language
summary: This project quantifies the extent to which infants can perceive audio–visual congruence for speech information and assesses whether this ability changes with native language exposure.<br>24 papers | 92 experiments | 1846 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "audiovisual_congruence")
dataset_raw <- metalab_data %>% filter(short_name == "audiovisual_congruence")
```
# `r dataset_info$name` 
