---
title: Word segmentation (neuro)
layout: data
type: dataset
tags: 
- early_language
summary: Infants’ recognition of familiarized content from running natural speech using brain measures<br>1 papers | 6 experiments | 69 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "wsnm")
dataset_raw <- metalab_data %>% filter(short_name == "wsnm")
```
# `r dataset_info$name` 
