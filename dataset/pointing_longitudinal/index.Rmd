---
title: Pointing and vocabulary (longitudinal)
layout: data
type: dataset
tags: 
- early_language
summary: Longitudinal correlations between pointing and later vocabulary.<br>18 papers | 18 experiments | 558 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "pointing_longitudinal")
dataset_raw <- metalab_data %>% filter(short_name == "pointing_longitudinal")
```
# `r dataset_info$name` 
