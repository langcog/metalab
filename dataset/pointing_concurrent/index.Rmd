---
title: Pointing and vocabulary (concurrent)
layout: data
type: dataset
tags: 
- early_language
summary: Concurrent correlations between pointing and vocabulary.<br>12 papers | 12 experiments | 319 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "pointing_concurrent")
dataset_raw <- metalab_data %>% filter(short_name == "pointing_concurrent")
```
# `r dataset_info$name` 
