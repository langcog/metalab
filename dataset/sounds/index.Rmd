---
title: Statistical sound category learning
layout: data
type: dataset
tags: 
- early_language
summary: Infants' ability to learn sound categories from their acoustic distribution.<br>11 papers | 20 experiments | 634 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "sounds")
dataset_raw <- metalab_data %>% filter(short_name == "sounds")
```
# `r dataset_info$name` 
