---
title: Language discrimination and preference
layout: data
type: dataset
tags: 
- early_language
summary: Discrimination of, or preference between, two language varieties, with results from various methods<br>36 papers | 153 experiments | 2263 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "langdiscrim")
dataset_raw <- metalab_data %>% filter(short_name == "langdiscrim")
```
# `r dataset_info$name` 
