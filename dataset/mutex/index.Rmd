...
tags: 
- early_language
summary: Bias to assume that a novel word refers to a novel object in forced-choice paradigms.<br>48 papers | 146 experiments | 2505 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "mutex")
dataset_raw <- metalab_data %>% filter(short_name == "mutex")
```
# `r dataset_info$name` 
