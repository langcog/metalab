...
tags: 
- early_language
summary: Infant word learning in the switch task<br>47 papers | 143 experiments | 2764 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "switchTask")
dataset_raw <- metalab_data %>% filter(short_name == "switchTask")
