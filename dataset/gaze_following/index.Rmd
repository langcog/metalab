---
title: Gaze following (live)
layout: data
type: dataset
tags: 
- cognitive_development
summary: Gaze following using standard multi-alternative forced-choice paradigms.<br>12 papers | 33 experiments | 491 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "gaze_following")
dataset_raw <- metalab_data %>% filter(short_name == "gaze_following")
```
# `r dataset_info$name` 
