---
title: Word segmentation (behavioral)
layout: data
type: dataset
tags: 
- early_language
summary: Recognition of familiarized content or non-words from running, natural speech using behavioral methods.<br>69 papers | 299 experiments | 5699 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "inworddb")
dataset_raw <- metalab_data %>% filter(short_name == "inworddb")
```
# `r dataset_info$name` 
