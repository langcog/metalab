---
title: Prosocial agents
layout: data
type: dataset
tags: 
- cognitive_development
summary: Do infants prefer a prosocial agent over an antisocial agent?<br>26 papers | 61 experiments | 1244 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "prosocial")
dataset_raw <- metalab_data %>% filter(short_name == "prosocial")
```
# `r dataset_info$name` 
