---
title: Categorization bias
layout: data
type: dataset
tags: 
- cognitive_development
summary: In a triad-task, bias to generalize to taxonomic as opposed to thematic alternative.<br>9 papers | 80 experiments | 328 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "catBias")
dataset_raw <- metalab_data %>% filter(short_name == "catBias")
```
# `r dataset_info$name` 
