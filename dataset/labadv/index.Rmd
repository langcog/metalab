---
title: Label advantage in concept learning
layout: data
type: dataset
tags: 
- early_language
summary: Infants' categorization judgments in the presence and absence of labels.<br>18 papers | 102 experiments | 1664 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "labadv")
dataset_raw <- metalab_data %>% filter(short_name == "labadv")
```
# `r dataset_info$name` 
