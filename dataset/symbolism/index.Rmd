...
tags: 
- early_language
summary: Bias to assume a non-arbitrary relationship between form and meaning ("bouba-kiki effect") in forced-choice paradigms.<br>11 papers | 44 experiments | 425 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "symbolism")
dataset_raw <- metalab_data %>% filter(short_name == "symbolism")
```
# `r dataset_info$name` 
