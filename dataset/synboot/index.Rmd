...
tags: 
- early_language
summary: Whether infants can correctly identify the references of the novel verbs embedded in a syntactically informative context.<br>18 papers | 60 experiments | 832 subjects
---
...
dataset_info <- dataset_info %>% filter(short_name == "synboot")
dataset_raw <- metalab_data %>% filter(short_name == "synboot")
```
# `r dataset_info$name` 
